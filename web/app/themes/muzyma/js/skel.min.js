    ...
    var e = "config"
      ...
      , Gt = {
        ...
        extend: function(e, t) {
            ...
            Gt[n](t, function(n) {
                Gt[$](t[n]) ? (Gt[$](e[n]) || (e[n] = []),
                Gt[X](e[n], t[n])) : typeof t[n] == b ? (typeof e[n] != b && (e[n] = {}),
                Gt[X](e[n], t[n])) : e[n] = t[n]
            })
        },
        getArray: function(e) {
            return Gt[$](e) ? e : [e]
        ...
        applyRowTransforms: function(t) {
            ...
            Gt[e].RTL && (Gt.unreverseRows(),
            u > 0 && Gt.reverseRows(u)),
            i = "_skel_cell_important_placeholder",
            r = Gt[s]("skel-cell-important"),
            r && r[f] > 0 && Gt[n](r, function(t) {
                if (t === f)
                    return;
                var n = r[t], s, o = n[l], c;
                if (!o)
        ...
        changeState: function(s) {
            ...
            if (!Gt[H][vt][Gt[r]]) {
                ...
                p = [],
                b = "mV" + Gt[r],
                c[e][P].content ? T = c[e][P].content : (c[e][P].scalable === a ? p[d]("user-scalable=no") : p[d]("user-scalable=yes"),
                ...
                if (!(g = Gt[m](b))) {
                    ...
                    O = k + L,
                    D = k * 1.25 + L,
                    g = Gt[w](b, Gt[E]("body{min-width:" + O + j + ".container{margin-left:auto;margin-right:auto;width:" + O + j + ".container.small{width:" + A + j + ".container.large{width:100%;max-width:" + D + ";min-width:" + O + j), F, 3)
                }
                c[i][d](g),
                b = "iGG" + c[e][S][h][kt] + "_" + c[e][S][h][at];
                if (!(g = Gt[m](b))) {
                    var B, W, V, $, J, G, Y;
                    p = Gt[C](c[e][S][h][kt]),
                    B = p[0],
                ...
                if (!(g = Gt[m](b))) {
                    ...
                    g = Gt[w](b, Gt[E](yt[U](/\.([0-9])/, Xt)), F, 3),
                    c[i][d](g)
                }
                Gt[n](u, function(r) {
                    Gt[t][u[r]][e][Qt] && (b = "ss" + u[r],
                    (g = Gt[m](b)) || (g = Gt[w](b, Gt.newStyleSheet(Gt[t][u[r]][e][Qt]), F, 5)),
                    c[i][d](g)),
                    Gt[t][u[r]][i][f] > 0 && Gt[n](Gt[t][u[r]][i], function(e) {
                        c[i][d](Gt[t][u[r]][i][e])
                    })
                }),
        ...
        poll: function() {
            ...
            e = Gt.getStateId(),
            e === "" && (e = Gt.sd),
            e !== Gt[r] && (Gt[Kt] ? Gt.changeState(e) : (Gt[N][Mt][g] = Gt[N][Mt][g][U](Gt[r][_](1)[U](new RegExp(Gt.sd,"g"), " "), ""),
            Gt.changeState(e),
            Gt[N][Mt][g] = Gt[N][Mt][g] + " " + Gt[r][_](1)[U](new RegExp(Gt.sd,"g"), " "),
            Gt[N][Mt][g].charAt(0) == " " && (Gt[N][Mt][g] = Gt[N][Mt][g][_](1))))
        },
        ...
        initAPI: function() {
            ...
            Gt[q][ot] = 99,
            e = "other",
            r[L](/Firefox/) ? e = "firefox" : r[L](/Chrome/) ? e = "chrome" : r[L](/Safari/) && !r[L](/Chrome/) ? e = "safari" : r[L](/(OPR|Opera)/) ? e = "opera" : r[L](/MSIE ([0-9]+)/) ? (e = "ie",
            Gt[q][ot] = RegExp.$1) : r[L](/Trident\/.+rv:([0-9]+)/) && (e = "ie",
            Gt[q][ot] = RegExp.$1),
            Gt[q].browser = e,
            Gt[q][O] = "other",
            t = {
            ...
            Gt[q].isTouch = Gt[q][O] == "wp" ? navigator.msMaxTouchPoints > 0 : "ontouchstart"in window,
            Gt[q].isMobile = Gt[q][O] == "wp" || Gt[q][O] == Wt || Gt[q][O] == "ios"
        },
        initConfig: function(r) {
            var s = []
              , o = [];
            typeof r == b && (r[t] && (Gt[e][t] = {}),
            Gt[X](Gt[e], r)),
            S in Gt[e] && h in Gt[e][S] && typeof Gt[e][S][h] != b && (Gt[e][S][h] = {
                vertical: Gt[e][S][h],
                horizontal: Gt[e][S][h]
            }),
            ...
            Gt[n](Gt[e][t], function(n) {
                ...
                u == "*" ? a = "" : u.charAt(0) == "-" ? a = "(max-width: " + parseInt(u[_](1)) + "px)" : u.charAt(u[f] - 1) == "-" ? a = Et + parseInt(u[_](0, u[f] - 1)) + "px)" : Gt[R](u, "-") != -1 && (u = u.split("-"),
                a = Et + parseInt(u[0]) + "px) and (max-width: " + parseInt(u[1]) + "px)"),
                s[Tt] = a),
                S in s && h in s[S] && typeof s[S][h] != b && (s[S][h] = {
                    vertical: s[S][h],
                    horizontal: s[S][h]
                }),
                Gt[e][t][n] = s,
        ...
        initElements: function() {
            ...
            t[d](Gt[A]("iGR", Gt[E](".row>*{float:left}.row:after{content:'';display:block;clear:both;height:0}.row:first-child>*{padding-top:0!important}.row.uniform>*>:first-child{margin-top:0}.row.uniform>*>:last-child{margin-bottom:0}"), F, 3)),
            Gt[ut](t)
        },
        initEvents: function() {
            var t;
        ...
        initUtilityMethods: function() {
            ...
            Gt[W] = function(e) {
                ...
                for (i in n)
                    t = n[i],
                    t.charAt(0) == "(" && (t = t[_](1, t[f] - 1),
                    r = t.split(/:\s+/),
                    r[f] == 2 && (s[r[0][U](/^\s+|\s+$/g, "")] = parseInt(r[1]),
                    o = D));
                if (!o)
                    return a;
