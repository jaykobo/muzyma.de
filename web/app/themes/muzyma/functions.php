...
function mp_cpt_strickmuetzen() {
    ...
    $args = array(
        ...
        'show_in_menu'          => true,
        'menu_position'         => 30,
        'menu_icon'             => '/app/themes/muzyma/img/menu-icons/icon-knit_cap.png',
...
function mp_cpt_genaehte_muetzen() {
    ...
    $args = array(
        ...
        'show_in_menu'          => true,
        'menu_position'         => 31,
        'menu_icon'             => '/app/themes/muzyma/img/menu-icons/icon-sew_machine.png',
        'show_in_admin_bar'     => true,
        'show_in_nav_menus'     => false,
        'can_export'            => true,
        'has_archive'           => false,
...
function mp_cpt_haekelmuetzen() {
    ...
    $args = array(
        ...
        'show_in_menu'          => true,
        'menu_position'         => 32,
        // 'menu_icon'             => '/app/themes/muzyma/img/menu-icons/MISSING_ICON_IMAGE.png',
...
function mp_cpt_yogakissen() {
    ...
    $args = array(
        ...
        'show_in_menu'          => true,
        'menu_position'         => 33,
        'menu_icon'             => '/app/themes/muzyma/img/menu-icons/icon-pillow.png',
        'show_in_admin_bar'     => true,
        'show_in_nav_menus'     => false,
        'can_export'            => true,
        'has_archive'           => false,
